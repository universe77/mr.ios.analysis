...
# choose background dataset list
id_bg <- background_ids(id_exp=id_exp, id_out=id_out, type="advanced")
...
# perform mr
dat <- harmonise_data(exp_dat, out_dat)
mr_res <- mr.ios_type(dat=dat, ios = ios_dat, ios_type = "ios1_mean", alpha = 0.05, weight = 6, tol = 0.0001) 
```
...
# perform mr
dat <- harmonise_data(exp_dat, out_dat)
mr_res <- mr.ios_type(dat=dat, ios = ios_dat, type = "ios1_mean", alpha = 0.05, 4, tol = 0.0001) 
```
...
# choose background dataset list
id_bg <- background_ids(id_exp=id_exp, id_out=id_out, type="general")
